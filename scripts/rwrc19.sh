...
## localmap maker
gnome-terminal -e "/opt/ros/${distro}/bin/roslaunch localmap_creator localmap_creator.launch --screen" --geometry=50x12+1000+500 &
sleep 1s
...
gnome-terminal -e "/opt/ros/${distro}/bin/rosrun rviz rviz -d ${ros_ws}/src/localmap_creator/config/localmap.rviz" --geometry=50x12+1500+500
